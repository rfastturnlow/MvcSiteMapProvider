namespace MvcSiteMapProvider.Core
{
    ...
    public interface INodeKeyGenerator
    {
        ...
        /// </returns>
        string GenerateKey(string parentKey, string key, string url, string title, string area, string controller, string action, string method, bool clickable);
    }
}